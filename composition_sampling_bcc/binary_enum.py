...
for base_species in base_species_pairs:
    if not os.path.isdir('%s%s_binary_DSS_%d' % (tuple(base_species) + tuple([cellmaxmult]) ) ):
        os.mkdir('%s%s_binary_DSS_%d' % (tuple(base_species) + tuple([cellmaxmult]) ))
    os.chdir('%s%s_binary_DSS_%d' % (tuple(base_species) + tuple([cellmaxmult]) ))
